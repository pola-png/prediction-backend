...
// Fetch and store finished results from OpenLigaDB
...
// Helper to get the current season for OpenLigaDB
...
// Fetch and store all matches (primary + fallback)
async function fetchAndStoreMatches() {
    ...
    // Historical football.json fallback
